    ...
    <div ref={revealRef} className="font-body min-h-screen bg-[#f5f2ed] text-[#1a2332] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0f1f2e]/95 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-3">
          <Link to="/" className="flex items-center gap-3">
            <img src="/coatcalc-logo.png" alt="CoatCalc" className="h-9 drop-shadow-[0_0_1px_rgba(255,255,255,0.3)]" />
          </Link>
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <div className="max-w-3xl">
            <div className="reveal">
              <img src="/coatcalc-logo.png" alt="CoatCalc" className="h-14 sm:h-16 mb-8" />
            </div>
      ...
      <footer className="bg-[#0a1520] text-white/30 py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <img src="/coatcalc-logo.png" alt="CoatCalc" className="h-7 opacity-60" />
