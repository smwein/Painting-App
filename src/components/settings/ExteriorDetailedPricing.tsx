...
import type { ExteriorModifierValues, ModifierScope, LineItemConfig } from '../../types/settings.types';
...
export function ExteriorDetailedPricing() {
  ...
  const renderSections = (sections: typeof exteriorSections) =>
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {(
            [
              { label: '3 Story', key: 'threeStory', labelKey: 'threeStoryLabel', scopeKey: 'threeStoryScope', helper: 'Applied for 3-story buildings' },
              ...
              { label: 'Hard Terrain', key: 'hardTerrain', labelKey: 'hardTerrainLabel', scopeKey: 'hardTerrainScope', helper: 'Applied for difficult terrain' },
            ...
            ] as { label: string; key: keyof ExteriorModifierValues; labelKey: keyof ExteriorModifierValues; scopeKey: keyof ExteriorModifierValues; helper: string }[]
            ...
            <div key={key} className="space-y-1">
              <div className="flex items-center gap-2">
                <div className="flex-1">
                  ...
                  <input
                    type="text"
                    value={(exteriorMods[labelKey] as string | undefined) ?? label}
                    onChange={(e) => setExteriorMods((p) => ({ ...p, [labelKey]: e.target.value }))}
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                  />
                </div>
                <div className="w-32">
